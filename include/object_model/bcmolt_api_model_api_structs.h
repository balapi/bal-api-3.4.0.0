...
typedef struct
{
    ...
    bcmolt_mep_cfg local_mep; /**< Tx MEP config */
    bcmolt_mep_cfg remote_mep; /**< Rx MEP config */
...
#define BCMOLT_LAG_INTERFACE_STATE_UPDATED_DATA_PRESENCE_MASK_ALL 0x0000000000000003ULL
