...
#define BCMOLT_INNI_CONFIG_PRESENCE_MASK_ALL 0x000000000000001FULL
...
{
    bcmolt_presence_mask presence_mask;
    uint16_t mep_name; /**< endpoint id */
    bcmolt_mep_type type; /**< type. */
    bcmolt_ccm_interval interval; /**< Sets CCM rate. LOC asserted after 3 missed Rx CCMs */
    uint16_t loc_clear_threshold; /**< Number of CCMs Rx'd before LOC de-asserted. This value must be 3 or less.. */
    bcmolt_control_state state; /**< state. */
} bcmolt_mep_cfg;

/* Constants associated with bcmolt_mep_cfg. */
